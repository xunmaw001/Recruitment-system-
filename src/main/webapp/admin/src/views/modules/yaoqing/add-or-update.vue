    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="gongsiId" name="gongsiId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="面试时间" prop="mianshiTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.mianshiTime"
                                type="datetime"
                                placeholder="面试时间"
                                :disabled="ro.mianshiTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.mianshiTime" label="面试时间" prop="mianshiTime">
                            <span v-html="ruleForm.mianshiTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="面试地点" prop="mianshiAddress">
                       <el-input v-model="ruleForm.mianshiAddress"
                                 placeholder="面试地点" clearable  :readonly="ro.mianshiAddress"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="面试地点" prop="mianshiAddress">
                           <el-input v-model="ruleForm.mianshiAddress"
                                     placeholder="面试地点" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="面试需知" prop="mianshiText">
                        <el-input type="textarea"  :readonly="ro.mianshiText" v-model="ruleForm.mianshiText" placeholder="面试需知"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.mianshiText" label="面试需知" prop="mianshiText">
                            <span v-html="ruleForm.mianshiText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   mianshiText: [
                              { required: true, message: '面试需知不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`yaoqing/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.yaoqingCrossAddOrUpdateFlag = false;
                                        this.parent.search();
