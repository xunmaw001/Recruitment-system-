    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(yaoqing !=null){
            ...
            BeanUtils.copyProperties( yaoqing , view );//把实体数据重构到view中
                ...
                //级联表
                GongsiEntity gongsi = gongsiService.selectById(yaoqing.getGongsiId());
                if(gongsi != null){
                ...
                //级联表
                YonghuEntity yonghu = yonghuService.selectById(yaoqing.getYonghuId());
                if(yonghu != null){
    ...
    */
    ...
    public R save(@RequestBody YaoqingEntity yaoqing, HttpServletRequest request){
        ...
        if(false)
            ...
            yaoqing.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        else if("公司".equals(role))
            yaoqing.setGongsiId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));

        Wrapper<YaoqingEntity> queryWrapper = new EntityWrapper<YaoqingEntity>()
            .eq("yonghu_id", yaoqing.getYonghuId())
            .eq("gongsi_id", yaoqing.getGongsiId())
...
//                            yaoqingEntity.setYonghuId(Integer.valueOf(data.get(0)));   //用户 要改的
//                            yaoqingEntity.setGongsiId(Integer.valueOf(data.get(0)));   //公司 要改的
